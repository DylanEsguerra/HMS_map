...
KF(:,:,2) = [0.9201	0.9793	0.9941
0.888	0.9486	0.9632
0.913	0.9713	0.9855
0.9117	0.9714	0.9853
0.9119	0.9734	0.9861];

KF_sd(:,:,2) = [0.0906	0.0719	0.0691
...
for i = 1:3
    for j = 1:2
        ...
        errorbar(obs_shift,KF(:,i,j),KF_sd(:,i,j),'-o','MarkerSize',10,'LineWidth',2)
