...
The docs folder contains the code used to  launch a Github pages website with instructions for how to apply HMSmap to emirical data.

<a href="docs/Example_Empirical.html">Page 2</a>
